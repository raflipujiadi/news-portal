...
<body class="font-sans antialiased">
    ...
    <div class="wrapper">
        ...
        <p class="teks">
            <strong>Yogyakarta, Jogja News</strong> - Memiliki smartphone menjadi hal yang penting bagi para siswa di
        ...
        <p class="teks">
            ...
            teknologi lainnya. Menurutnya handphone lebih mudah di akses baik untuk belajar maupun untuk mengikuti trend
            terkini.</p>
        <p class="teks">
        ...
        <p class="teks">
            ...
            Aplikasi ini memuat informasi tentang Program Jaminan Kesehatan Nasional - Kartu Indonesia Sehat (JKN-KIS)
            yang dirasa sangat berguna untuk Rian. Rian mengakui berkat Mobile JKN, dirinya dapat mengetahui jenis
            kepesertaan dirinya dan keluarga, serta mendapatkan informasi terkini baik tentang Program JKN-KIS maupun
            fasilitas kesehatan yang bekerjasama dengan BPJS Kesehatan.</p>
        <p class="teks">
            "Saya dan keluarga terdaftar di Puskesmas Meureubo sebagai fasilitas kesehatan tingkat I. Berarti nanti jika
            mau berobat cukup membawa HP saja? Tidak perlu membawa kartu lagi?," tanya Rian antusias.</p>
        <p class="teks">
            Dalam kesempatan yang sama, Rian sangat bersyukur menjadi salah satu anak muda yang mendapatkan informasi
            langsung tentang aplikasi Mobile JKN. Menurut Rian penggunaan aplikasi Mobile JKN sangat sesuai dengan trend
            masa kini. Selain itu aplikasi ini merupakan salah satu aplikasi yang wajib ada di smartphone remaja
            lainnya.</p>
        <p class="teks">
            "Menurut Rian lebih gampang pakai Mobile JKN daripada bawa kartu. Pasti kawan-kawan yang lain juga setuju
