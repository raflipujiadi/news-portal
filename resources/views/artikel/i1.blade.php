...
<body class="font-sans antialiased">
    ...
    <div class="wrapper">
        ...
        <p class="teks"> <strong>Yogyakarta, Jogja News</strong> - Tahun 2021 ini tepat bagi para Generasi Y alias
            Generasi Milenial tua memasuki umur 40 tahun. Berdasarkan konsensus global, milenial adalah generasi yang
            lahir pada awal tahun 1980-an hingga pertengahan 1990-an, atau tahun 1981 hingga 1996 sebagaimana disebut
        ...
        <p class="teks">
            ...
            mengalami dua kali resesi ekonomi, yang berdampak pada pendidikan, karier, keuangan, rencana hidup, dan
        ...
        <p class="teks">
            Secara kesimpulan hasilnya, para milenial tua ini menilai mereka memilih jalur karier yang berbeda ketika
            mereka memulai karier pertama kalinya.
            Namun data menunjukkan keputusan yang telah mereka buat di tahun-tahun sebelumnya juga membuat mereka
        ...
        <p class="teks">
            "Kita semua memiliki pola pikir 'lulus kuliah langsung dapat pekerjaan.' Kemudian ketika Anda sudah masuk
