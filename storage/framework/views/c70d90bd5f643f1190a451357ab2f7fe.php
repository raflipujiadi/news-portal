...
<div class="mb-6">
<a href="<?php echo e(route('password.request')); ?>" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">Forgot your password?</a>
<a href="<?php echo e(route('register')); ?>" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">Don't have an account? Register</a>
</div>
</form>
    </div>
    <?php if($errors->any()): ?>
    ...
    <?php endif; ?><?php /**PATH D:\Programming\php\Laravel\final project\news-portal\resources\views/auth/login.blade.php ENDPATH**/ ?>