...
<body class="font-sans antialiased">
    ...
    <div class="wrapper container">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <a href="#"><img src="<?php echo e(asset('images/img/covid.jpg')); ?>" class="d-block w-100"
                                alt="..."></a>
                    </div>
                    <div class="carousel-item">
                        <a href="#"><img src="<?php echo e(asset('images/img/gambar1.jpg')); ?>" class="d-block w-100"
                                alt="..."></a>
                    </div>
                    <div class="carousel-item">
                        <a href="#"><img src="<?php echo e(asset('images/img/gambar2.jpg')); ?>" class="d-block w-100"
                                alt="..."></a>
                    </div>
                </div>
        ...
        <div class="wrapper container">
            ...
            <section>
                <div class="wrapper kolom">
                    <img src="<?php echo e(asset('images/img/gambar1.jpg')); ?>" alt="Ini Gambar">
                    <p class="deskripsi"></p>
            ...
            <section>
                <div class="wrapper kolom">
                    <img src="<?php echo e(asset('images/img/gambar2.jpg')); ?>" alt="Ini Gambar">
                    <p class="deskripsi"></p>
            ...
            <section>
                <div class="wrapper kolom">
                    <img src="<?php echo e(asset('images/img/gambar3.jpeg')); ?>" alt="Ini Gambar">
                    <p class="deskripsi"></p>
            ...
            <section>
                <div class="wrapper kolom">
                    <img src="<?php echo e(asset('images/img/gambar4.png')); ?>" alt="Ini Gambar">
                    <p class="deskripsi"></p>
            ...
            <section>
                <div class="wrapper kolom">
                    <img src="<?php echo e(asset('images/img/covid.jpg')); ?>" alt="Ini Gambar">
                    <p class="deskripsi"></p>
